...
module ps_pl_hdmi_wrapper
  ...
  wire uart_driver_rxd;
  wire uart_driver_txd;
  wire uart_lidar_rxd;
  wire uart_lidar_txd;
  ...
  ps_pl_hdmi ps_pl_hdmi_i
       (.DDR_addr(DDR_addr),
        ...
        .uart_driver_rxd(uart_driver_rxd),
        .uart_driver_txd(uart_driver_txd),
        .uart_lidar_rxd(uart_lidar_rxd),
        .uart_lidar_txd(uart_lidar_txd));
endmodule
