...
HD_PWD='/home/adt/robot_ros/git/vivado_project/all/X_Ubuntu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_pl_hdmi_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ps_pl_hdmi_wrapper.tcl -notrace
