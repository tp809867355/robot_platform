...
HD_PWD='/home/adt/robot_ros/git/vivado_project/all/X_Ubuntu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_pl_hdmi_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ps_pl_hdmi_wrapper.tcl
