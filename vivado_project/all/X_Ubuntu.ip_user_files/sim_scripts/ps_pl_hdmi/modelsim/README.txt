...
#
# Generated by export_simulation on Thu Jul 20 09:49:27 +0800 2017
#
################################################################################
...
switch to the './ps_pl_hdmi.sh' script.

./ps_pl_hdmi.sh -reset_run
...
./ps_pl_hdmi.sh -noclean_files

For more information on the script, please type './ps_pl_hdmi.sh -help'.
